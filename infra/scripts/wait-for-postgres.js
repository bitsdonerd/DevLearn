...
class LoadingSpinner {
  constructor(message = "Waiting for PostgreSQL connections to be ready", intervalTime = 100) {
  ...
  start() {
    this.interval = setInterval(() => {
      const frame = this.loadingFrames[this.loadingIndicator++ % this.loadingFrames.length];
